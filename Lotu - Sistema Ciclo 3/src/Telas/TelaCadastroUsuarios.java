...
public class TelaCadastroUsuarios extends javax.swing.JFrame {
     ...
     * O mesmo gera os dados do cartão conforme os dados do usuário
     */
    public void gerarCartao(String CPF) {
        boolean verifica = false;
        verifica = VerificaNumeros(CPF, "CPF");
        if (verifica) {
        }
    ...
    public void setDataValidade() {
		...
		GregorianCalendar calendar = new GregorianCalendar();
                Date dataHoje;
                dataHoje = new Date(GregorianCalendar.YEAR + 113 , GregorianCalendar.MONTH + 1, GregorianCalendar.DATE);
                              
                String validade = formatter.format(dataHoje);         

                tbx_validadeGerada.setText(validade);
                cartao_gerado = true;
    ...
    public boolean ValidaCadastro() {
        ...
        if (CPFValidado == true && RGValidado == true && CEPValidado == true && NOMEValidado == true && CIDADEValidado == true && UFValidado == true && EmailValidado == true) {
            /*
             * Informa que o Cadastro está valido e verifica se ja foi gerado o cartão
             */
            valida = true;
    ...
    private void initComponents() {
        ...
        tbx_CpfUsuarioCartao = new javax.swing.JTextField();
        ...
        tbx_CpfUsuarioCartao.setEditable(false);
                    ...
                    .addGroup(tbx_cpfGeradoLayout.createSequentialGroup()
                        .addGroup(tbx_cpfGeradoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(tbx_cpfGeradoLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tbx_CpfUsuarioCartao, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(tbx_cpfGeradoLayout.createSequentialGroup()
        ...
        tbx_cpfGeradoLayout.setVerticalGroup(
            ...
            .addGroup(tbx_cpfGeradoLayout.createSequentialGroup()
                ...
                .addGroup(tbx_cpfGeradoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel19)
                    .addComponent(tbx_CpfUsuarioCartao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(tbx_cpfGeradoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel20)
    ...
    private void btn_cadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_cadastrarMouseClicked
        ...
        if (verifica == true) {
            ...
            lbl_03.setVisible(false);
            if (!cartao_gerado) {
                JOptionPane.showMessageDialog(rootPane, "É preciso Gerar o Cartão para concluir o Login");
            } else {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        /*
         * Verifica se ao clicar já foi gerado, se sim, informa o erro
         */
        if (!cartao_gerado) {
            boolean verifica_dados = false;
            verifica_dados = ValidaCadastro();
            if (verifica_dados) {
                long numCartao;
                String Cartao;
                numCartao = (int) (Math.random() * 1000000000);
                Cartao = String.valueOf(numCartao);

                while (numCartao == 0) {
                    numCartao = (long) (Math.random() * 1000000000);
                    Cartao = String.valueOf(numCartao);
                }


                tbx_numCartaoGerado.setText(Cartao);
                tbx_ufCartaoGerado.setText(tbx_UF.getText());

                setDataValidade();


                tbx_CpfUsuarioCartao.setText(tbx_cpf.getText());
                tbx_SaldoCartao.setText("R$ 0,00");
            } else {
                JOptionPane.showMessageDialog(rootPane, "O Cadastro contém erros.\r\nVerifique os Campos em Vermelho");
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "O Cartão já foi Gerado!");
        }
    ...
    private javax.swing.JTextField tbx_CpfUsuarioCartao;
